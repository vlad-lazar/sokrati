      ...
      <DrawerContent>
        <div className="mx-auto w-full flex flex-col  justify-center items-center">
          ...
          <div className="flex-1 overflow-y-auto px-20 pb-8">
            ...
            <p className="mb-4 text-sm text-muted-foreground">
              **Future Vision:** AI will analyze your notes, understand your
              emotional tone, and even suggest insights that help you grow and
              find what truly resonates with you.
            </p>

            <div className="flex flex-col justify-center align-center w-full  text-center">
